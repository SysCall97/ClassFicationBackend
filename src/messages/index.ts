...
export const ASSIGNMENT_NOT_FOUND: string = "Assignment not found";
export const SUBMISSION_NOT_FOUND: string = "Submission not found";
...
export const TEACHER_FORBIDDEN_ACTION: string = "Teacher is not allowed for this action";
